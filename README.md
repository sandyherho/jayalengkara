...
> The nomenclature `jayalengkara` is drawn from the **Serat Jayalengkara Wulang**, a didactic Javanese verse romance that recounts the wanderings of **Prince Jayalengkara** and his visits to sages in secluded places who instruct him in hidden and mystical science. The best known witness, British Library MSS Jav. 24, was copied at the court of Sultan Hamengkubuwana II of Yogyakarta and begun on 22 Rejeb in the Javanese year 1730, corresponding to 7 November 1803; it is written in verse across ninety-three cantos in the quadratic script of the Yogyakarta court, and is celebrated for its finely illuminated frames, the *wadana*. In the narrative the prince completes his instruction and ascends the throne of Sonya Wibawa under the regnal title Prabu Surya Dipaningrat. The word *wulang* denotes teaching, and the poem interweaves ethical and mystical instruction with the story of the journey. The name is adopted here for a library whose purpose is analogous: to travel through a family of probability distributions and render the hidden geometric structure that the Fisher-Rao metric assigns to it.
